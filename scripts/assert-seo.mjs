...
for (const locale of locales) {
  ...
  assert(html.includes('property="og:image:secure_url" content="https://olivesxxxx.github.io/imagex/og-image.svg"'), `${locale}: og:image:secure_url`);

  // x-default 尾斜杠
  assert(html.includes('hreflang="x-default" href="https://olivesxxxx.github.io/imagex/"'), `${locale}: x-default trailing slash`);
