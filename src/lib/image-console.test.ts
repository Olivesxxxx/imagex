...
describe("image console logic", () => {
  ...
  test("uses ImageX as the download filename prefix for image generation", () => {
    expect(
      imageDownloadName({
        method: "gpt-image-2",
        title: "260617-1801-1",
    ...
    ).toBe("ImageX-260617-1801-1.png");
  });

  test("uses ImageX as the download filename prefix for edit requests", () => {
    expect(
      imageDownloadName({
        method: "edit",
        title: "260617-1801-1",
